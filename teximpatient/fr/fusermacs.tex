...
noms des divers macros expliquent leurs buts, mais habituellement 
...
suppl\'emen\-taire (que vous le pouvez voir dans la d\'efinition ci-
dessous).
...
contr\^ole ne sont pas accessible de l'ext\'erieur de ce fichier (\`a moins 
...
Les deux macros suivantes fournissent un formulation pratiques de 
r\'esultat de diagnostique. \pix^|\loggingall| d\'eclenche tout le 
...
d\'efaut que vous voulez en la red\'efinissant |\vruledefaultwidth|, |\hruledefaultheight| et |\hruledefaultdepth| et 
en employant 
\pix^^|\ehrule|
|\eh!-rule| et 
...
langages de programmation traditionnel.  ces macros viennent directement de
\LaTeX.
...
\knuth{Exercise~11.6}{}.^^{fractions//en forme de slash} 
...
Les macros suivants produisent des logos qui sont utiles dans le monde \TeX. 
Le logo \AMSTeX\ viens de la \knuth{page~420}{999}. Le logo \LaTeX\ 
...
emploie |\sevenrm| au lieu d'une v\'eritable police de capitale-et-
petite-capitale. Le fichier source |.mf| pour le logo \MF\ est 
donn\'e dans le manuel \MF\ manuel~: 
...
(\xref{listmacs}). \pix^|\makeblankbox| (de \knuth{page~311}{999}) 
produit un rectangle non rempli, avec l'\'epaisseur des traits de 
bordure donn\'ees par les arguments. 
...
\pix^|\numbername| produit la forme en toute lettre d'un nombre. (si 
...
Par d\'efaut, \TeX\ centres le mat\'eriel affich\'e (le mat\'eriel 
...
\pix^|\ifleqno| sera vrai si un |\leqno| appara\^\i t. Si l'un ou l'autre 
sorte d'\'equation num\'erot\'ee se appara\^\i t, \pix^|\eqn| produit le texte 
du num\'ero de l'\'equation. \pix^|\eq| produit toujours le texte de 
l'\'equation lui-m\^eme. 

Ces macros sont bas\'ees sur le code de la \knuth{page~376}{999}.
...
commencent par \pix^|\li| (``list item''). Vous peut mettre 
...
droite de chaque \'el\'ement de liste est donn\'ee par |\list!-right!-%
indent|.
...
en police |\tt|.
Elle est bas\'ee sur le code de la \knuth{page~380}{999}.
Les tabulations produisent un montant d'espace fixe et les sauts de pages 
...
\xrdef{xrefs}
Les macros qui suivent fournissent des r\'ef\'erences crois\'ees symbolique, pour 
...
simple, avec des lignes compl\'et\'ees d'un c\^ot\'e ou de l'autres comme 
...
l'espace entre la marque de la notes de bas de page (par exemple, le num\'ero) et le 
...
composition en double colonnes, alors que la commande 
...
composition en double colonnes. 

L'approche est d\'eriv\'ee de la \knuth{page~417}{999}.
...
travail, |\box255| aura le mat\'eriel en double colonnes. Le mat\'eriel en 
double colonnes sera pr\'ec\'ed\'e par n'importe quel mat\'eriel en colonne simple 
