...
familiaris\'e avec \TeX. Nous supposons que nos lecteurs sont habitu\'es au 
...
d'in\-dication pour que vous puissiez commencer si vous n'avez jamais utilis\'e 
...
choses comme des formules de maths contiennent beaucoup de commandes, alors que 
...
de cette r\'evision (voir le \xref{newtex}).

{\tighten Vous pouvez utiliser une forme sp\'ecialis\'ee de \TeX\ comme 
^{\LaTeX} ou ^{\AMSTeX} (voir les \xref{ressources}). Bien que ces formes 
...
d\'eveloppement il a \'et\'e une source d'encouragement et conseil valable. Nous 
...
certain nombre de petite mais irritantes erreurs seraient demeur\'ees dans ce 
