...
vari\'et\'e de commandes \TeX\ de dans un nombre de pages restreint, les 
...
quelques termes techniques peu familier. Dans la \chapterref{concepts}, 
...
dans le livre. L'int\'erieur de la couverture de dos du livre contient une 
...
descriptions de commande sur la \xrefpg{cmddesc}. Les descriptions de 
...
Et si vous \^etes d\'erout\'e par les messages d'erreur de \TeX, vous 
...
\li ``Commandes pour les composer des pages'', \chapterref{pages}, 
...
modes hori\-zontaux (les paragraphes et les hbox) et les modes verticaux 
(les pages et les vbox). Ces commandes fournissent les bo\^\i tes, les 
espaces, les r\`egles, les leaders et les alignements.
\li ``Commandes pour composer les formules de maths'', 
...
(pour quelques commandes ils ne sont pas). Quand vous regardez une sous-
section contenant des commandes fonctionnellement li\'ees, regardez en fin 
de sous-section l'article ``voir aussi'' pour vous assurer qu'il ne renvoie 
...
(\xref{arg1}). Les arguments d'une commande fournissent \`a \TeX\ une 
