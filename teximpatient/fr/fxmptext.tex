...
\TeX\ n'a pas besoin de savoir comment coupez les lignes dans
...
point.  Il traite les point d'interrogation et d'exclamation de la
m\^eme mani\`ere.   
...
simple et double adjacente, ins\'erez un`espace fin'\thinspace''. Vous
...
\`a savoir o\`u fini l'un et o\`u commence l'autre.
...
doublement indent\'e si vous en avez besoin. Ceci en est un 
exemple.\par}
...
des deux, avec deux\/ {\rm mots en romain} ins\'er\'es}.
...
de \TeX\ ne vous en donnerons pas de plus petit de {\fiverm celui-l\`a}.
...
``$\Omega$'' pour les utilisez en math\'ematique, des couleurs de carte 
...
les manuscrits ait un espacement double. L'espacement double est
rarement appropri\'e pour les documents finis, n\'eanmoins.
...
base. regardez le source pour voir comment faire. Vous pouvez
...
\medskip
{\raggedright   Vous pouvez composer une texte non justifi\'e, c'est-\`a-dire, 
