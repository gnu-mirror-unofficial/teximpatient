...
L'interpr\'etation des messages d'erreur des \TeX\ peut parfois \^etre 
compar\'ee \`a aller chez votre m\'edecin avec la sensation d'\^etre 
fatigu\'e et obtenir, en r\'eponse, une anomalie de votre chimie sanguine. 
...
dans ce cas-ci, \'egalement, les deux lignes suivante) vous indiquent o\`u 
...
de message indique la position pr\'ecise de \TeX\ dans la ligne $291$, \`a 
...
de la plus commune que vous puissiez obtenir. Si vous r\'epondez au prompt 
...
continuerons \`a appara\^\i tre sur votre terminal et dans le \logfile.
...
niveau les plus secrets o\`u le \TeX \ travaille. Dans le cas de l'exemple 
...
l.93 ...Skip \smallskip a little further.}
                                           But no more.
|
Les messages d'erreur ici vous donnent un tour d'horion des macros qui sont 
utilis\'ees dans l'impl\'ementation de |\leftline| dans \plainTeX---des 
macros auxquelles vous ne vous inqui\'etez probablement pas. La premi\`ere 
...
\'egalement la d\'efinition de |\smallskip| et indique o\`u \TeX\ est 
parvenu en d\'evelop\-pant et en ex\'ecutant cette d\'efinition. 
Sp\'ecifiquement, il a juste essay\'ee sans succ\`es d'ex\'ecuter la 
commande |\vskip|. En g\'en\'eral, une ligne diagnostique qui commence par 
une commande suivi de `|->|' indique que \TeX\ a d\'evelopp\'e et 
...
position apr\`es |#1| indique que la derni\`ere chose qu'il a vu \'etait le 
...
\endolist
\noindent
Dans un long message comme ceci, vous ne trouverez g\'en\'eralement utile 
...
juste avant l'accolade droite ins\'er\'e. Notez en particulier que dans ce 
