...
et des commandes \TeX\ d\'efinies dans \plainTeX. Cela inclus les s\'equences de
contr\^ole et les caract\`eres  
sp\'eciaux.
Nous avons omis les commandes qui ne sont utilis\'ees qu'a l'usage interne de la d\'efinition 
...
``symbole'', ``relation'', ``d\'elimiteur'', or ``op\'erateur'' dans une description de 
commande implique que la commande n'est l\'egale qu'en mode math\'ema\-tique.
 
\li Le verbe ``afficher'' s'applique \`a l'information que \TeX\ envoie au ^{\logfile}, 
sauf indication contraire. Si |\tracingonline| est positif, \TeX\ envoie \'egalement 
cette information sur le terminal. Nous utilisons le nom ``affichage'' pour nous 
...
Nous omettons parfois ``produit'' quand l'omission ne peut porter \`a
...
\capac $ {commence ou fini une formule math\'ematique}{}{mathform}
...
\capcs abovedisplayshortskip {ressort \TeX\ ins\'er\'e avant un affichage quand la 
   ligne pr\'ec\'edente d\'epasse l'indentation d'affichage, par 
   d\'efaut 0\pt\ plus 3\pt}*{}
\capcs abovedisplayskip {ressort \TeX\ ins\'er\'e avant un affichage quand la 
...
\capcs beginsection {d\'ebute une subdivision majeur d'un document}{}%
   {\@beginsection}
...
\capcs bordermatrix {produit une matrice avec des labels de rang\'es et de colonnes}{}{}
\capcs bot {lattice bottom symbol~: $\bot$}{}{}
\capcs botmark {le dernier \'el\'ement marqu\'e de la page qui vient d'\^etre mise en bo\^\i te}*{}
...
\capcs brokenpenalty {p\'enalit\'e pour une coupure de ligne sur un \'el\'ement discr\`etionnaire, par
   d\'efaut~100}*{}
\capcs buildrel {produit une formule sp\'ecifi\'e sur la relation sp\'ecifi\'e}{}{}
...
\capcs char {produit le caract\`ere de la police courante avec le code 
   sp\'ecifi\'e}*{}
\capcs chardef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'e comme \'etant un code de
...
\capcs colon {colon punctation symbol en math\'ematique~: $:$}{}{}
...
\capcs countdef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'ee comme \'etant un nombre
   correspondant \`a un registre |\\count|}*{}
\capcs cr {termine une rang\'e (ou une colonne) dans un alignement}*{}
...
\capcs dimendef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'ee comme \'etant un nombre
...
\capcs displaylimits {place des limites sur et sous des op\'erateurs seulement en styles
   d'affichage}*{}
...
\capcs displaywidth {\TeX\ met ceci pour la largeur d'une affichage}*{}
...
\capcs dotfill {rempli un espace horizontal d\'elimit\'e avec des points}{}{}
...
\capcs dp {la profondeur de la bo\^\i te d'un registre de bo\^\i te sp\'ecifi\'e}*{}
\capcs dump {termine l'ex\'ecution et produit un fichier de format}*{}
\capcs edef {d\'efini une s\'equence de contr\^ole comme \'etant une macro, 
...
\capcs ell {script letter en math\'ematique~: $\ell$}{}{}
...
\capcs endgroup {termine un group\'e d\'ebut\'e par |\\begingroup|}*{}
...
\capcs eqalign {produit un affichage multi-lignes sp\'ecifi\'e dont les parties indiqu\'es
...
\capcs everymath {liste de token que \TeX\ d\'eveloppe quand un texte en mode math\'ematique
    d\'ebute}*{}
\capcs everypar {liste de token que \TeX\ d\'eveloppe quand une paragraphe d\'ebute}*{}
...
\capcs expandafter {ne d\'eveloppe le token suivant qu'apr\`es d\'eveloppement du token
   le suivant}*{}
\capcs fam {famille de police que \TeX\ utilise pour des caract\`eres de classe sept
   (c'est-\`a-dire, des variables) en math}*{}
\capcs fi {termine une condition}*{\@fi}
\capcs filbreak {force une coupure de page \`a moins que le texte contienne un autre |\\filbreak|
...
\capcs font {d\'efini une s\'equence de contr\^ole sp\'ecifique pour s\'electionner une police}*{}
...
\capcs gdef {\'equivalent \`a |\\global\\def|, c'est-\`a-dire, d\'efini une macro globale}*{}
...
\capcs hfuzz {space threshold for reporting overfull hboxes, par d\'efaut 
   0.1\pt}*{}
\capcs hglue {produit un ressort horizontal qui ne disparait pas sur des
   coupure de ligne}{}{}
\capcs hidewidth {ignore la largeur d'une entr\'ee d'un alignement, so that it
...
\capcs holdinginserts {si positive, n'enl\`eve pas d'insertions de la
   page courante}*{}
...
\capcs hrule {produit un filet horizontal~; l\'egale seulement en modes verticaux}*{}
\capcs hrulefill {rempli un espace d\'elimit\'e d'un filet horizontal}{}{}
\capcs hsize {longeur de ligne, par d\'efaut 6.5\thinspace in}*{}
...
\capcs ifcat {teste si deux tokens sp\'ecifi\'es ont le m\^eme code de
   cat\'egorie}*{\@ifcat}
\capcs ifdim {teste for a specified relationship between two specified
   dimensions}*{\@ifdim}
\capcs ifeof {test la fin d'un fichier sp\'ecifi\'e}*{\@ifeof}
...
\capcs ifx {teste si deux tokens sont les m\^eme, ou si
...
\capcs insert {produit une insertion d'un classe sp\'ecifi\'ee}*{}
...
\capcs ldots {point sur la ligne de base en math\'ematique~: $\ldots$}{}{}
\capcs le {relation inf\'erieur ou \'egal~: $\le$}{}{}
\capcs leaders {rempli un espace horizontal ou vertical sp\'ecifi\'e en r\'ep\'etant un
...
\capcs let {d\'efini une s\'equence de contr\^ole comme \'etant le token suivant}*{}
...
\capcs limits {place un exposant sur et un indice sous un
   grand op\'erateur}*{}
\capcs limsup {fonction limite sup\'erieur~: $\limsup$}{}{}
\capcs line {produit une ligne de caract\`ere justifi\'ee}{}{}
...
\capcs lineskip {ressort vertical d'une ligne de base \`a la suivante si les
   lines sont plus proche l'une de l'autre que |\\lineskiplimit|, par d\'efaut 1\pt}*{}
\capcs lineskiplimit {threshold for using |\\lineskip| instead of
   |\\base\-line\-skip|, par d\'efaut 0\pt}*{}
...
\capcs lowercase {converti les lettres capitales du texte sp\'ecifi\'e
   en minuscule}*{}
...
\capcs mathchardef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'e comme \'etant un mathcode,
...
\capcs message {montre le d\'eveloppement du texte sp\'ecifi\'e sur le terminal}*{}
...
\capcs muskipdef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'e comme un nombre
   correspondant \`a un regisstre |\\muskip|}*{}
...
\capcs newif {d\'efini un nouveau test conditionel avec le nom sp\'ecifi\'e}{}{\@newif}
...
\capcs noindent {entre en mode horizontal sans indentet le paragraphe}*{}
...
\capcs nonstopmode {ne stoppe pas sur des erreurs, m\^eme celles relatives aux fichier manquants}*{}
...
\capcs normalbottom {rend la marge du bas identiques de page en page}{}{}
...
\capcs normallineskiplimit {valeur de |\\lineskiplimit| pour la taille de caract\`ere
   courante}{}{}
\capcs not {un slash sans largeur pour construire des n\'egations de relation
...
\capcs pagestretch {\TeX\ met ceci au montant total de \'etirement
   sur la page courante}*{}
\capcs pagetotal {\TeX\ met ceci \`a la hauteur naturelle de la page
   courante}*{}
\capcs par {fini un paragraphe et termine le mode horizontal}*{\@par}
...
\capcs prevdepth {profondeur de la derni\`ere bo\^\i te dans la liste verticale courante
   (sauf filet)}*{}
\capcs prevgraf {\TeX\ met ceci au nombre de ligne dans le paragraphe en plus
...
\capcs raggedright {autorise la marge droite \`a varier d'une line \`a l'autre}{}{}
...
\capcs relpenalty {p\'enalit\'e suppl\'ementaire pour une coupure apr\`es une relation,
   par d\'efaut~500}*{}
\capcs repeat {termine une boucle d\'ebut\'e avec |\\loop|}{}{\@repeat}
...
\capcs right {produiy le d\'elimiteur sp\'ecifi\'e \`a l'extr\`emit\'e d'une
   sous-formule d\'ebut\'ee par |\\left|}*{}
\capcs rightarrow {relation~: $\rightarrow$}{}{}
\capcs Rightarrow {relation~: $\Rightarrow$}{}{}
\capcs rightarrowfill {remplit une hbox contenante avec un |\\rightarrow|~:
...
\capcs rlap {produit du texte (sans largeur) \`a partir de la droite
   de la position courante}{}{}
\capcs rm {utilise des caract\`ere romain, c'est-\`a-dire, fait |\\tenrm\\fam=0|}{}{}
...
\capcs scriptspace {espace suppl\'ementaire que \TeX\ cr\`ene apr\`es un exposant ou un
   indice, par d\'efaut 0.5\pt}*{}
\capcs scriptstyle {utilise la taille de style script dans une formule}*{}
\capcs scrollmode {ne stoppe pas sur les erreurs, mais stoppe sur des erreurs
   de fichiers manquants}*{}
\capcs searrow {relation fl\`eche en bas \`a gauche~: $\searrow$}{}{}
\capcs sec {fonction s\'ecante~: $\sec$}{}{}
\capcs setbox {d\'efini un registre de bo\^\i te sp\'ecifi\'e comme \'etant une bo\^\i te}*{}
\capcs setlanguage {change une jeu de r\`egles de c\'esure sp\'ecifi\'e, mais
   ne change pas |\\language|}{*}{}
\capcs setminus {set difference operator~: $\setminus$}{}{}
\capcs settabs {d\'efini les tabulations pour une alignement tabul\'e}{}{}
...
\capcs shipout {envoie une bo\^\i te vers le fishier |.dvi|}*{}
\capcs show {montre, dans la log et 
   sur le terminal, la signification d'un token sp\'ecifi\'e}*{}
\capcs showbox {affiche le contenu d'une registre de bo\^\i te sp\'ecifi\'e}*{}
\capcs showboxbreadth {nombre maximum d'\'el\'ements montr\'e sur chaque niveau imbriqu\'e,
   par d\'efaut~5}*{}
\capcs showboxdepth {maximum de niveau imbriqu\'e montr\'e, par d\'efaut~3}*{}
\capcs showhyphens {montre, dans la log
   et sur le terminal, les c\'esure dans un texte sp\'ecifi\'e}{}{}
...
\capcs skipdef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'e  comme \'etant un nombre
...
\capcs smallskipamount {ressort pour une petit saut vertical, par d\'efaut 3\pt\
...
\capcs spadesuit {symbole tr\`efle~: $\spadesuit$}{}{}
...
\capcs textindent {comme |\\item|, mais ne fait pas d'indentation accroch\'ee}{}{}
...
\capcs thickmuskip {ressort pour une espace math\'ematique grasse, par d\'efaut 5\mud\ plus 5\mud}*{}
\capcs thinmuskip {ressort pour une espace math\'ematique fine, par d\'efaut 3\mud}*{}
...
\capcs toksdef {d\'efini une s\'equence de contr\^ole sp\'ecifi\'e comme \'etant un nombre
   correspondant \`a un registre |\\toks|}*{}
\capcs tolerance {tol\'erance de m\'ediocrit\'e pour des coupure de ligne avec c\'esure}*{}
...
\capcs tracingall {d\'eclenche des traces maximal}{}{}
...
\capcs tracingonline {montre les sorties de diagnostique sur le terminal aussi bien que
   dans le fichier log}*{}
...
\capcs tt {utilise des caract\`ere de machine \`a \'ecrire, c'est-\`a-dire, fait |\\tentt\\fam=\\ttfam|}{}{}
\capcs ttfam {famille machine \`a \'ecrire en math\'ematique}{}{}
\capcs ttraggedright {utilise des caract\`ere de machine \`a \'ecrire et autorise le marge
...
\capcs uchyph {si positif, laisse c\'esurer des mots qui commence avec une
   lettre capitale}*{}
\capcs underbar {underline the specified text without avoiding
   any descenders, comme dans \underbar{fog}}{}{}
...
\capcs uppercase {converti les lettres minuscules d'un texte sp\'ecifi\'e
   en capitale}*{}
...
\capcs varsigma {variant de la lettre grecque $\varsigma$}{}{}
...
\capcs vfootnote {produit un note de bas de page sp\'ecifi\'ee avec une marque 
   de r\'ef\'erence sp\'ecifi\'ee, mais ne produit la marque de r\'ef\'erence dans le texte}{}{}
\capcs vfuzz {space threshold for reporting overfull vboxes, par d\'efaut 
   0.1\pt}*{}
...
\capcs widowpenalty {p\'enalit\'e pour une seule ligne d\'ebutant une page, 
   par d\'efaut~150}*{}
\capcs wlog {|\\write| la liste de token sp\'ecifi\'ee dans le fichierlog}{}{}
\capcs wp {symbole Weierstra\ss\ `p'~: $\wp$}{}{}
\capcs wr {op\'erateur wreath product~: $\wr$}{}{}
...
\capcs xdef {\'equivalent \`a |\\global\\edef|, c'est-\`a-dire, d\'efini globalement une
   macro, d\'eveloppant imm\'ediatement le texte de replacement}*{}
\capcs xi {lettre grecque math\'ematique $\xi$}{}{}
\capcs Xi {lettre grecque math\'ematique $\Xi$}{}{}
\capcs xleaders {produit des leaders avec l'espace en trop \`a gauche redistribu\'e egalement
   entre les bo\^\i tes leader}*{}
